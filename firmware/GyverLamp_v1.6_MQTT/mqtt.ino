...
String Get_EFFName (int eff_idx) {
  ...
  switch (eff_idx) {
    ...
    case 28: return "Butterflys";
    case 29: return "Rain";
    case 30: return "Thunderstorm";
    case 31: return "Rubik's Cube";
    case 32: return "Nexus";
    case 33: return "Demo";
  }
  ...
  switch (eff_idx) {
    ...
    case 27: return "Стая";
    case 28: return "Мотыльки в банке";
    case 29: return "Дождь";
    case 30: return "Гроза";
    case 31: return "Кубик Рубика";
    case 32: return "Nexus";
    case 33: return "Демо";
  }
