...
void routeInfo() {
  ...
  out +="<tr>";
  #ifdef ENG
  out +="<td>MQTT connection</th>";
  #else
  out +="<td>Связсь с MQTT сервером</th>";
  #endif  
  out +="<td>                              </th>";
  
  #ifdef ENG
  mqttclient.connected() ? out +="<td> established </th>" : out +="<td> lost </th>";
  #else
  mqttclient.connected() ? out +="<td> установлена </th>" : out +="<td> отсутствует </th>";
  #endif
  out +=" </tr>";
  ...
  out = "<form>";
      ...
      out += "<div class='ui-field-contain'>";
        ...
        out += "<select name='currentMode' id='currentMode' data-mini='true'>";
          ...
          out += "<option value='28'>Butterflys</option>";
          out += "<option value='29'>Rain</option>";
          out += "<option value='30'>Thunderstorm</option>";
          out += "<option value='31'>Rubik's Cube</option>";
          out += "<option value='32'>Nexus</option>";          
          out += "<option value='33'>Demo</option>";
  ...
  out = "<form>";
      ...
      out += "<div class='ui-field-contain'>";
        ...
        out += "<select name='currentMode' id='currentMode' data-mini='true'>";
          ...
          out += "<option value='28'>Мотыльки в банке</option>";
          out += "<option value='29'>Дождь</option>";
          out += "<option value='30'>Гроза</option>";
          out += "<option value='31'>Кубик Рубика</option>";
          out += "<option value='32'>Nexus</option>";          
          out += "<option value='33'>Демо</option>";
